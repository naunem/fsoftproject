...
public class PnFood extends javax.swing.JPanel implements ActionListener {
    ...
    public JButton getBtPriceFood() {
        return btPriceFood;
    }

    public void setBtPriceFood(JButton btPriceFood) {
        this.btPriceFood = btPriceFood;
    }
    ...
    private void initComponents() {
        ...
        btPriceFood = new javax.swing.JButton();
        ...
        btPriceFood.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/warning_16.png"))); // NOI18N
        btPriceFood.setText("Xem giá");
        btPriceFood.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btPriceFoodActionPerformed(evt);
            }
        });
        pnFoodInTacVu.add(btPriceFood);
    ...
    private javax.swing.JButton btPriceFood;
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == btFoodThem) {
            try {
                ...
                JOptionPane.showMessageDialog(null, "Giá phải viết bằng chữ số!");
                tfFoodPrice.setText("");
